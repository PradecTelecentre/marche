        ...
        <div class="collapse navbar-collapse header" id="navbarsExampleDefault">
            ...
            <li class="nav-item dropdown ">
                ...
                <div class="dropdown-menu bg-goon " style="border: 0;background: #db8428; text-align: center" aria-labelledby="dropdown01">
                    <a class="dropdown-item" style="color: black;" href="education">EDUCATION</a>
                    <a class="dropdown-item" style="color: black;" href="information">INFORMATION</a>
                    <a class="dropdown-item" style="color: black;" href="parlons">PARLONS</a>
                    <a class="dropdown-item" style="color: black;" href="http://localhost:5000">MARCHE</a>
                    <a class="dropdown-item" style="color: black;" href="games">JEUX</a>
                </div>
            </li>
                <li class="nav-item">
                    <a class="nav-link" style="color: black;" href="apropos">A-PROPOS <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" style="color: black;" href="contact">CONTACTS <span class="sr-only">(current)</span></a>
                </li>
